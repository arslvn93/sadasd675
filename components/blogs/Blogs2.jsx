        ...
        <div className="row">
          <div className="col-12">
            <div className="box-title">
              <h2>{`${siteContent.agent.name}'s Blog`}</h2>
              {/* Removed layout toggle buttons */}
            </div>
            <div className="grid-layout-3">
              {/* Assuming we want to show the same posts as Blogs6, using siteContent.blog.posts */}
              {siteContent.blog.posts.map((post, i) => (
                <div key={i} className="blog-article-item style-2">
                  <div className="image-wrap">
                    <Image
                      className="lazyload"
                      alt={post.alt.replace('{Location}', siteContent.agent.location)}
                      width={600}
                      height={396}
                      src={post.imageSrc}
                    />
                  ...
                  <div className="article-content">
                    ...
                    <h4 className="title line-clamp-3">
                      <Link href={`/blog-details/${post.id}`}>
                        {post.title.replace('{Location}', siteContent.agent.location)}
                      </Link>
                    </h4>
                    <Link
